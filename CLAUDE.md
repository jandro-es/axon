...
- `@docs/03-requirements.md` — **FR-01…FR-205 / NFR-01…NFR-14**. The contract. Trace your work to these IDs.
...
- User-facing references: `@docs/COMMANDS.md` (every CLI command), `@docs/AUTOMATIONS.md` (all 25 automations, does/doesn't), `@docs/PROFILES.md` (personal vs work).
