...
- `@docs/02-architecture.md` — module boundaries, data flow, **ADR-001…037**.
- `@docs/03-requirements.md` — **FR-01…FR-190 / NFR-01…NFR-14**. The contract. Trace your work to these IDs.
...
- User-facing references: `@docs/COMMANDS.md` (every CLI command), `@docs/AUTOMATIONS.md` (all 24 automations, does/doesn't), `@docs/PROFILES.md` (personal vs work).
