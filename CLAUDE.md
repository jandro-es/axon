...
- `@docs/02-architecture.md` — module boundaries, data flow, **ADR-001…040**.
- `@docs/03-requirements.md` — **FR-01…FR-209 / NFR-01…NFR-14**. The contract. Trace your work to these IDs.
