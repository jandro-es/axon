...
func (d *profileDeps) buildServices(bus *events.Bus) services {
	...
	pipeline := &ingestion.Pipeline{
		...
		Vision: vision, STT: stt, STTMaxMinutes: d.profile.Ingestion.STT.MaxMinutesOr(), MediaHosts: d.profile.Ingestion.MediaHosts, CaptionLangs: d.profile.Ingestion.CaptionLangs,
	}
