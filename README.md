...
**The vault maintains itself.** Twenty-two scheduled automations — inbox triage,
...
| [Automation engine](docs/06-component-automation-engine.md) | Scheduler, the twenty-two standard automations, agentic runs. |
