...
### Subscriptions *(planned — spec approved 2026-07-04, not yet built)*

FR-91…FR-93 trace to ADR-019 and the spec in
`docs/superpowers/specs/2026-07-04-subscriptions-design.md`. Priorities are
