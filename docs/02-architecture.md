...
**Trade-offs:** unconditional hourly GETs (no ETag/304 — cheap at personal scale, noted future optimization); a transiently-failed item is lost unless explicitly re-ingested; feeds are managed by the `axon subscribe` CLI (FR-100, spec approved 2026-07-04) or by editing config.yaml. (Spec: `docs/superpowers/specs/2026-07-04-subscriptions-design.md`; FR-91…FR-93, FR-100.)
