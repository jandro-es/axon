...
**Trade-offs:** a transiently-failed item is lost unless explicitly re-ingested; feeds are managed by the `axon subscribe` CLI (FR-100) or by editing config.yaml. Polling is conditional (ETag/304, FR-101 — spec approved 2026-07-04). (Spec: `docs/superpowers/specs/2026-07-04-subscriptions-design.md`; FR-91…FR-93, FR-100, FR-101.)
