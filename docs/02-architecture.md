...
### ADR-018 — The proactive layer: deterministic briefing with a local-routable narrative, and vector resurfacing with proposal memory *(accepted — spec approved, not yet built)*
